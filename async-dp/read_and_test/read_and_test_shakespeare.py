...
import json
from Shakespeare_simple import Shakespeare
from Shakespeare_simple import LSTM
from torch.nn import CrossEntropyLoss
from pathlib import Path
    
def eval(base_dir):
    """
    Reads from base_dir/models folder the saved models and evaluates them on the test set of Shakespeare.
    ...
    with open(
        os.path.join(base_dir, "0_testset_results.json"), "w"
    ) as of:
